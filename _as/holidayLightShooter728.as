package {
	...
	public class holidayLightShooter728 extends MovieClip {
		...
		private var leftRightInc:uint = 1;
		...
		public function holidayLightShooter728() {
			...
			xTrajectoryOffset = 300/rightMax;
			updateTargetPath();
			initBanner();
		...
		private function updateTargetPath():void {
			...
			var cannonMidArcX = 314 + (cannon_mc.rotation * (xTrajectoryOffset * xTrajectoryMidArcOffset));
			...
			targetDestinationY = stage.stageHeight/6 + ((1.12 - cannon_mc.scaleY)*200);// max = 1.12, min = .8;
