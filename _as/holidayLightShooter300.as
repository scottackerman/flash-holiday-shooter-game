package {
	...
	public class holidayLightShooter300 extends MovieClip {
		...
		public function holidayLightShooter300() {
		...
		private function updateTargetPath():void {
			...
			targetDestinationY = stage.stageHeight/6 + ((1.12 - cannon_mc.scaleY)*450);// max = 1.12, min = .8;
